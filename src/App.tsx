          ...
          {({ handleSubmit, submitting }) => (
            <form onSubmit={handleSubmit}>
              ...
              <div className="form-field">
                ...
                <Field name="firstName" component="input" type="text" placeholder="John"/>
              </div>
              <div className="form-field">
                <label>Last Name</label>
                <Field name="lastName" component="input" type="text" placeholder="Smith"/>
              </div>
              <div className="form-field">
                <label>Email</label>
                <Field name="email" component="input" type="email" placeholder="email@gmail.com"/>
              </div>
              <div className="form-field">
                <label>Telephone number</label>
                <Field name="telephoneNumber" component="input" type="text" placeholder="+66 0945781234" />
              </div>
              <div className="form-field">
                <label>Gender</label>
              ...
              <div className="form-field">
                <label>GPA</label>
                <Field name="gpa" component="input" type="number" step="0.01" placeholder="4.00" />
              </div>
              <div className="form-field">
              ...
              <div className="form-field">
                <label>Age</label>
                <Field name="age" component="input" type="number" placeholder="How old are you?"/>
              </div>
              <div className="form-field">
                <label>Address</label>
